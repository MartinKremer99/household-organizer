  ...
  return (
    <div className="fixed inset-0 z-20 flex items-end justify-center bg-foreground/40 p-4 sm:items-center">
      <div
        ...
        tabIndex={-1}
        className="max-h-[min(90dvh,40rem)] w-full max-w-lg overflow-y-auto overscroll-contain rounded-t-sheet rounded-b-card border border-border bg-surface-elevated p-4 outline-none sm:rounded-card"
      >
